    ...
    return (
      <>
        <div id="title">
          ...
          <p>Llena los campos a continuación para agregar una nueva cadena y su primer restaurante</p>
        </div>
        
        <form>
          <label id="cadena" for="rname">Nombre de la cadena</label><br></br>
          <input type="text" id="cname" name="rname"></input><br></br><br></br>
